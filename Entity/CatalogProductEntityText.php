...
/**
 * Entity for table "catalog_product_entity_text".
 *
 * @ORM\MappedSuperclass
 */
abstract class CatalogProductEntityText
{
    /**
     * @var int
     *
     ...
     *
     * @ORM\ManyToOne(targetEntity="CatalogProductEntity", inversedBy="textAttributes")
