...
/**
 * Entity for table "catalog_product_entity_varchar".
 *
 * @ORM\MappedSuperclass
 */
abstract class CatalogProductEntityVarchar
{
    /**
     * @var int
     *
     ...
     *
     * @ORM\ManyToOne(targetEntity="CatalogProductEntity", inversedBy="varcharAttributes")
